...
describe User do
  ...
  describe "passwords validations" do
    ...
    it "sould require a matching password confirmation" do
    ...
    it "sould reject short passwords" do
      long = "a" * 41 
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email with no user" do
         User.authenticate("non@existent.email",@attr[:password]).should be_nil
      end
